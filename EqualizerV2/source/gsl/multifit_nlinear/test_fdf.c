...
#include <gsl/multifit_nlinear/test_bard.c>
#include <gsl/multifit_nlinear/test_beale.c>
#include <gsl/multifit_nlinear/test_biggs.c>
#include <gsl/multifit_nlinear/test_box.c>
#include <gsl/multifit_nlinear/test_boxbod.c>
#include <gsl/multifit_nlinear/test_brown1.c>
#include <gsl/multifit_nlinear/test_brown2.c>
#include <gsl/multifit_nlinear/test_brown3.c>
#include <gsl/multifit_nlinear/test_eckerle.c>
#include <gsl/multifit_nlinear/test_enso.c>
#include <gsl/multifit_nlinear/test_exp1.c>
#include <gsl/multifit_nlinear/test_gaussian.c>
#include <gsl/multifit_nlinear/test_hahn1.c>
#include <gsl/multifit_nlinear/test_helical.c>
#include <gsl/multifit_nlinear/test_jennrich.c>
#include <gsl/multifit_nlinear/test_kirby2.c>
#include <gsl/multifit_nlinear/test_kowalik.c>
#include <gsl/multifit_nlinear/test_lin1.c>
#include <gsl/multifit_nlinear/test_lin2.c>
#include <gsl/multifit_nlinear/test_lin3.c>
#include <gsl/multifit_nlinear/test_meyer.c>
#include <gsl/multifit_nlinear/test_meyerscal.c>
#include <gsl/multifit_nlinear/test_osborne.c>
#include <gsl/multifit_nlinear/test_penalty1.c>
#include <gsl/multifit_nlinear/test_penalty2.c>
#include <gsl/multifit_nlinear/test_powell1.c>
#include <gsl/multifit_nlinear/test_powell2.c>
#include <gsl/multifit_nlinear/test_powell3.c>
#include <gsl/multifit_nlinear/test_rat42.c>
#include <gsl/multifit_nlinear/test_rat43.c>
#include <gsl/multifit_nlinear/test_rosenbrock.c>
#include <gsl/multifit_nlinear/test_rosenbrocke.c>
#include <gsl/multifit_nlinear/test_roth.c>
#include <gsl/multifit_nlinear/test_thurber.c>
#include <gsl/multifit_nlinear/test_vardim.c>
#include <gsl/multifit_nlinear/test_watson.c>
#include <gsl/multifit_nlinear/test_wood.c>

#include <gsl/multifit_nlinear/test_wnlin.c>
